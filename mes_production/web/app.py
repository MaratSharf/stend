...
from web.auth import AuthService, require_api_key
import yaml
import os
...
def create_app(config: dict = None) -> Flask:
    ...
    def index():
        ...
        return render_template('index.html', api_key=app.config.get('frontend_api_key'))

    @app.route('/tracking')
    def tracking():
        """Station tracking page."""
        return render_template('tracking.html', api_key=app.config.get('frontend_api_key'))
